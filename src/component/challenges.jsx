...
import { Target, Trophy, Loader2, Flag, AlertCircle, Lightbulb, CheckCircle2, Lock, Star, ChevronLeft, AlertTriangle } from 'lucide-react'; 
    ...
    try {
      ...
      if (response.data.success) {
        ...
        if (response.data.correct) {
          ...
          toast.error("Incorrect Flag. Progress logged, no XP awarded.");
        }
